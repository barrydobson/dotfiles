...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%242F╰─%F{yellow}❯'
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      '*prod*'    PROD      # These values are examples that are unlikely
      '*shared*'  SHARED    # to match your needs. Customize them as needed.
      '*'         DEFAULT)
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND='000'
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_BACKGROUND='004'
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_CONTENT_EXPANSION='${P9K_KUBECONTEXT_CLOUD_NAME} > ${P9K_KUBECONTEXT_NAME}/${P9K_KUBECONTEXT_NAMESPACE} <'
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHARED_BACKGROUND=orange
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHARED_FOREGROUND=white
